...
async def test_1000__timeout_wait_for_first_message(
    ...
    # get timeouts
    timeout_wait_for_first_message = 40
...
#
# NOTE: Could not get this test to work (fail) consistently but scenario does happen in the real-world
#
...
#             wait_between_messages=wait_between_messages,
#         ),
#         # NOTE: consume_and_reply() should timeout waiting for 1st message
#         consume_and_reply(
#             cmd="""python3 -c "
# output = open('in.txt').read().strip() * 2;
# print(output, file=open('out.txt','w'))" """,  # double cat
