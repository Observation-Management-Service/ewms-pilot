...
# TODO: generic parser tests


def test_100__apptainer__all_apptainer_logs(tmp_path: Path):
    """Test."""
...
def test_110__apptainer__stacktrace(tmp_path: Path):
    """Test."""
    temp_file = tmp_path / "test.log"
    test_content = textwrap.dedent(  # fixes """-indentation
        """
...
def test_111__apptainer__stacktrace(tmp_path: Path):
    """Test."""
    temp_file = tmp_path / "test.log"
    test_content = textwrap.dedent(  # fixes """-indentation
        """
...
def test_120__apptainer__one_line_error(tmp_path: Path):
    """Test."""
    temp_file = tmp_path / "test.log"
    test_content = textwrap.dedent(  # fixes """-indentation
        """
